...
import { useWorkspace } from 'src/hooks/context/WorkspaceContext'; 
...
export type WorkspacesPopoverProps = ButtonBaseProps & {
  ...
  onChangeWorkspace: (workspace: { id: string; name: string; logo: string; plan: string }) => void;
};

export function WorkspacesPopover({ data = [], onChangeWorkspace, sx, ...other }: WorkspacesPopoverProps) {
  ...
  const handleChangeWorkspace = useCallback(
    ...
    [setWorkspace,handleClosePopover, onChangeWorkspace, setCurrentWorkspace]
  );
